  ...
  return (
    <div style={{ padding: '60px 16px 100px' }}>
      ...
      <Card style={{ marginBottom: 16 }}>
        ...
        <div style={{ marginTop: 14, paddingTop: 12, borderTop: '1px solid #F1F5F9', fontSize: 13, color: '#94A3B8', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span>Auth via Clerk</span>
          <span style={{ color: '#16A34A', fontWeight: 600 }}>● Signed in</span>
        </div>
        <button
          onClick={() => signOut()}
          style={{ marginTop: 12, width: '100%', padding: '10px', borderRadius: 10, border: '1.5px solid #FEE2E2', background: 'transparent', color: '#E11D48', fontWeight: 700, fontSize: 13, cursor: 'pointer' }}
        >
          Sign Out
        </button>
      </Card>
